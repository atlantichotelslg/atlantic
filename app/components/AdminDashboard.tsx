...
import { LOCATIONS, getLocationAddress, getLocationFullAddress } from '@/lib/locations';
...
export default function AdminDashboard({ userName }: AdminDashboardProps) {
  ...
  const fetchFromCloud = async () => {
    ...
    try {
      ...
      // Merge with local receipts (avoid duplicates)
      ...
      if (newReceipts.length > 0) {
        ...
        // Save new receipts to localStorage
            ...
            <div className="p-8">
              ...
              >
                ...
                <div className="flex justify-between items-start mb-8 border-b-2 border-gray-300 pb-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">vinayak@atlanticslagos.com</p>
                    </div>
                  </div>
                ...
                <div className="mt-12 text-center text-xs text-gray-500">
                  ...
                  <p className="mt-1">For inquiries, please contact us at vinayak@atlanticslagos.com</p>
                </div>
              </div>
            </div>
          </div>
